...
import { fundingFootnote } from "../model/pack";
...
export class TelstarNowPlaying extends SignalWatcher(LitElement) {
  ...
  /** YouTube-style funding footnote for the playing channel (localized country name), or null. */
  #fundingNote(ch: Channel): string | null {
    ...
    return fundingFootnote(ch.funding, countryName);
  }
